...
void halBoardInit(void)
{
    ...
    //CC2592
    MCU_IO_DIR_OUTPUT(HAL_BOARD_IO_PAEN_PORT, HAL_BOARD_IO_PAEN_PIN);
    MCU_IO_DIR_OUTPUT(HAL_BOARD_IO_LNAEN_PORT, HAL_BOARD_IO_LNAEN_PIN);
    MCU_IO_DIR_OUTPUT(HAL_BOARD_IO_HGM_PORT, HAL_BOARD_IO_HGM_PIN);
